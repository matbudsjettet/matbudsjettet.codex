  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-background">
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(1rem,env(safe-area-inset-top))]">
        ...
        {/* Hero */}
        <div className="mb-4 rounded-2xl bg-[#1A3225] p-5.5 text-center text-white">
          <div className="mx-auto mb-3.5 grid h-16 w-16 place-items-center rounded-full bg-[#D4A017]/20">
          ...
          <p className="mt-1.5 text-[0.875rem] text-white/70">Få enda mer ut av appen</p>
        ...
        {/* Features */}
        <div className="mb-4 rounded-2xl bg-surface border border-border shadow-card overflow-hidden">
          {features.map((f, i) => (
            <div key={f} className={`flex items-center gap-3 px-4.5 py-3.5 ${i > 0 ? "border-t border-border-subtle" : ""}`}>
        ...
        {/* Pricing */}
        <div className="mb-3.5 rounded-2xl bg-surface border border-border shadow-card p-4.5 text-center">
        ...
        {/* Trial note */}
        <div className="mb-4 rounded-2xl bg-[#EBF5EF] border border-saving-border px-4 py-2.5 text-center text-[0.82rem] font-bold text-brand">
        ...
        <div className="mt-3 space-y-0.5 text-center text-[0.75rem] text-text-tertiary">
